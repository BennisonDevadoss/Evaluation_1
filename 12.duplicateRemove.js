"use strict";
let array = [{ id: 1, name: "Stephen covey" }, { id: 2, name: "Robin Sharma" }, { id: 3, name: "Tolstoy" }, { id: 3, name: "Tolstoy" }, { id: 5, name: "bennison" }, { id: 5, name: "James clear" }];
...
outer: for (i = 0; i < length; i++) {
    ...
    if (i > 0) {
        ...
        for (j = 0; j <= copy_of_k; j++) {
            if (array[i].id === newArray[j].id || array[i].name === newArray[j]) {
                continue outer;
            }
        }
    }
